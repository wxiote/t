...
.menu {
  ...
  background-size: 110% auto; /* léger zoom pour rogner un peu à gauche */
  background-position: 97% -20px; /* décale légèrement vers la gauche, toujours proche du bord droit */
}
